...
const WebHostingPlan = () => {
    return (
        <div className='flex flex-col items-center justify-center gap-2 w-3/4 rounded p-4 bg-gray-200 mb-7 md:w-2/4 lg:w-1/4'>
            ...
            <div className='mt-6'>
                ...
                <div className='flex items-center text-green-700 mb-1 ps-3'>
                    <Home /> 100 GB SSD Storage
                </div>
                <div className='flex items-center text-green-700 mb-1 ps-3'>
                    <Home /> Weekly Backups
                </div>
                <div className='flex items-center text-green-700 mb-1 ps-3'>
                    <Home /> Unlimited Bandwidth
                </div>
                <div className='flex items-center text-green-700 mb-1 ps-3'>
                    <Home /> Free SLL
                </div>
